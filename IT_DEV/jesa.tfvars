rg_name         = "rg-it-dev-euw"
global_location = "westeurope"
rg_tags         = { Environment = "Dev", Department = "IT" }

rg_lock_name = "lock-rg-it-dev-euw-01"


hub_resource_group_name = "rg-netw-glob-euw"
hub_vnet_name           = "vnet-s2s-aks-glob-euw-01"

spoke_vnet_name           = "vnet-aks-it-dev-euw-01"
spoke_vnet_address_spaces = ["10.244.0.0/16"]
spoke_vnet_tags           = { Environment = "Dev", Department = "IT" }

subnet_aks_name             = "snet-aks-it-dev-euw-01"
subnet_aks_address_prefixes = ["10.244.0.0/17"]

subnet_private_endpoints_name             = "snet-pep-aks-it-dev-euw-01"
subnet_private_endpoints_address_prefixes = ["10.244.128.0/24"]

hub_to_spoke_peering_name                 = "peer-itdev-glob-euw-01"
...
aks_cluster_name                         = "aks-it-dev-euw-01"
aks_cluster_node_resource_group          = "mc-rg-it-dev-euw"
aks_cluster_sku_tier                     = "Free"
aks_cluster_k8s_version                  = "1.28.3"
aks_cluster_dns_prefix                   = "aksitdev01"
...
aks_cluster_system_node_pool_os_disk_size_gb       = 128
...
aks_cluster_user_node_pool_node_count            = 1
aks_cluster_user_node_pool_node_min_count        = 1
aks_cluster_user_node_pool_node_max_count        = 2
aks_cluster_user_node_pool_node_vm_size          = "standard_B2s"
aks_cluster_user_node_pool_os_disk_size_gb       = 128
...
aks_cluster_node_os_sku       = "Ubuntu"
aks_cluster_identity_type     = "SystemAssigned"


aks_lb_public_ip_name              = "pip-aks-it-dev-euw-01"
...
acr_resource_group_name = "rg-it-glob-euw"
acr_name                = "acritglobeuw01"


cosmos_db_account_name                            = "cosmos-it-dev-euw-01"
...
cosmosdb_account_private_endpoint_name           = "pepcosmositdev01"
private_service_connection_cosmosdb_account_name = "psconcosmositdev01"
cosmosdb_account_private_endpoint_tags           = { Environment = "Dev", Department = "IT" }


webapp_service_plan_name = "asp-it-dev-euw-01"
webapp_service_sku       = "S1"
webapp_service_os        = "Linux"
webapp_service_plan_tags = { Environment = "Dev", Department = "IT" }

webapp_name = "app-gw-it-dev-euw-01"
webapp_tags = { Environment = "Dev", Department = "IT" }

webapp_dev_slot_name = "slot-gw-it-dev-euw-01"
...
storage_account_name                          = "stitdeveuw01"
...
redis_cache_name                                    = "redis-it-dev-euw-01"
